...
Only requiring some minor changes is orbit.cpp.
...
Changes to orbit.cpp
----------------------
orbit.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
