...
This mechanism has been integrated into Bitcore-Node-Orbit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/orbit-team/insight-api-orbit#web-socket-api](https://github.com/orbit-team/insight-api-orbit#web-socket-api) 
* API: [https://github.com/orbit-team/insight-api-orbit#instantsend-transactions](https://github.com/orbit-team/insight-api-orbit#instantsend-transactions) 
...
By default, the Orbit Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Orbit Core daemon:
