...
{
    if(fLiteMode) return; // ignore all Orbit related functionality
...
/*
    ...
    allow endless transaction that would bloat Orbit and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("orbit-privatesend");
