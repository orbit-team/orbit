...
2. run orbitd with -printalert or -sendalert like this:
   /path/to/orbitd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.orbit.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Orbit Core:0.12.0.58/"));
