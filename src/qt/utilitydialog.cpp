    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Orbit Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Orbit Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  orbit-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Orbit in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ORBIT, 0.1 ORBIT, 1 ORBIT and 10 ORBIT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://orbit-team.atlassian.net/wiki/display/DOC/PrivateSend\">https://orbit-team.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Orbit Core is shutting down...") + "<br /><br />" +
