    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ORBIT-light"), QVariant("light"));
    ui->theme->addItem(QString("ORBIT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ORBIT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ORBIT-traditional"), QVariant("trad"));
