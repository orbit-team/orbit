    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Orbit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Orbit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and orbit: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Orbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Orbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Orbit Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Orbit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Orbit addresses"));
    ...
    openAction->setStatusTip(tr("Open a orbit: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Orbit Core help message to get a list with possible Orbit Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Orbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Orbit network", "", count));
}
...
{
    QString strTitle = tr("Orbit Core"); // default title
