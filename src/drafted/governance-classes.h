 ...
 *
 *   // network
 *   COrbitNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.orbit.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COrbitNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: OrbitNetwork
// //   -- signature requirements : Key1(User)
// class COrbitNetworkVariable : public CGovernanceObject
// {
// private:
