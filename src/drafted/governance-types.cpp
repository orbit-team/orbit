...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "OrbitNetwork") type = OrbitNetwork;
    if(strType == "OrbitNetworkVariable") type = OrbitNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == OrbitNetwork) s = "OrbitNetwork";
    if(type == OrbitNetworkVariable) s = "OrbitNetworkVariable";
